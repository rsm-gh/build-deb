...
**`build-deb` is a program to easily create Debian packages for binaries or interpreted languages (Python, Bash, Perl, etc...). For understanding the basics of Debian packages you can read [this article](https://www.senties-martinelli.com/articles/debian-packages).**
